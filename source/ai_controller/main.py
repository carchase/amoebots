...
OPTIONS = {
    ...
    'MIN_COLORS': [[0, 78, 121], [40, 37, 98], [118, 51, 93], [96, 111, 143]], #minimum value for corresponding colors [0] arena (orange) [1] smores3 (green) [2] smores2 (purple) [3] smores1 (blue) [3] available (light blue)
    'MAX_COLORS': [[20, 144, 176], [81, 127, 195], [166, 204, 223], [117, 203, 244]], #maximum value for corresponding colors [0] arena (orange) [1] smores3 (green) [2] smores2 (purple) [3] smores1 (blue) [3] available (light blue)
